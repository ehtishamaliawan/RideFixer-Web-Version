...
<header>
  <div class="wrap nav">
    <a href="/" class="brand" aria-label="RideFixer home">
      <img src="/assets/img/ridefixer-icon.svg" alt="RideFixer" style="width:42px;height:42px;border-radius:12px;box-shadow:0 10px 28px rgba(0,0,0,.28);" />
      <span>RideFixer</span>
    </a>
    ...
    <nav class="links" aria-label="Main navigation">
      ...
      <a href="https://play.google.com/store/apps/details?id=com.bytefixer.ridefixer" target="_blank" rel="noopener" class="shop-pill" style="background:linear-gradient(135deg,#22c55e,#14b8a6);">
        Get App
      </a>
...
<div class="wrap" style="margin-top:18px;">
  <div style="background:linear-gradient(135deg,rgba(34,197,94,.14),rgba(20,184,166,.12));border:1px solid rgba(255,255,255,.08);padding:14px 18px;border-radius:18px;display:flex;align-items:center;justify-content:space-between;gap:18px;flex-wrap:wrap;">
    <div style="display:flex;align-items:center;gap:14px;">
      <img src="/assets/img/ridefixer-icon.svg" alt="RideFixer app" style="width:54px;height:54px;border-radius:16px;" />
      <div>
